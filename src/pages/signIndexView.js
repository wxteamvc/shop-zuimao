...
export default class SignIndex extends Component {
    ...
    sign(){
        let url = SIGN_URL+'&__ice_shop_member_session_1=';
        if (global.isConnected) {
            Util.post(url,{},
                (resq) => {
                    if (resq.status == 1) {
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={[styles.header_item]}>
                            <Image
                                ...
                                style={styles.image}
                            />
                            <Text style={styles.font}>{this.state.member.nickname}</Text>
