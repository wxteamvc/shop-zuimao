    ...
    renderYouLike({ item }) {
        ...
        return (
            ...
            style={styles.item_container} onPress={() => { this.props.navigate.navigate('GoodsInfo', { id: item.id }) }}>
                ...
                <TouchableOpacity style={styles.buy_car} onPress={() => {this.props.loginData.status === "success"? fun(item):Toast.show('亲 请先登录哦',{position: Toast.positions.BOTTOM}) }}>
...
export default connect(mapStateToProps)(YouLike);